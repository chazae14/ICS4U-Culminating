...
{
    public partial class GoodEnding : Form
    {
        public GoodEnding()
        {
            InitializeComponent();
        ...
        private void GoodEnding_KeyDown(object sender, KeyEventArgs e)
        {
            if (tmrMove.Enabled == false)
            {
                ...
                if (curX > 17 * tileSize && curX < 19 * tileSize && curY < 12 * tileSize && curY > 14 && e.KeyCode == Keys.E)
                {
                    picRealLetter.Show();
                    lblTransparent.Show();
                }
        ...
        private void picRealLetter_Click(object sender, EventArgs e)
        {
        ...
        private void GoodEnding_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void GoodEnding_Load(object sender, EventArgs e)
        {
            Graphics G;
            ...
            bmpLetter = new Bitmap(frmG.picLetter.Image, tileSize, tileSize);
            ...
            /// friend sprite 
            rectDest = new Rectangle(18 * tileSize, 12 * tileSize, tileSize, tileSize);
            gback.DrawImage(bmpLetter, rectDest, rect0, GraphicsUnit.Pixel);
            map[18, 12] = 8;

            // rectDest to start out sprite on her bed
            rectDest = new Rectangle(9 * tileSize, 8 * tileSize, tileSize, tileSize);
            rectSource = new Rectangle(9 * tileSize, 8 * tileSize, tileSize, tileSize);
